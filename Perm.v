...
Proof. 
  intros. induction H.
  - apply Forall_nil.
  - inversion H0. apply IHPermutation in H4. apply Forall_cons. apply H3. apply H4.
  - apply Forall_cons.
    + rewrite Forall_forall in H0. apply H0. simpl. right. left. reflexivity.
    + apply Forall_cons.
      {rewrite Forall_forall in H0. apply H0. simpl. left. reflexivity. }
      {inversion H0. inversion H3. apply H7. }
  - apply IHPermutation1 in H0. apply IHPermutation2 in H0. apply H0.
Qed.
