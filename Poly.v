...
(** ... but this would quickly become tedious, partly because we
    have to make u  p different constructor names for each datatype, but
...
(** Which of the following are well-typed elements of [grumble X] for
    some type [X]?
      ...
      - [e bool (b c 0)]
      - [c]
Ans) [d mumble (b a 5)] ; [d bool (b a 5)] ; [e bool true] ; e mumble (b c 0) ;
*)
(** [] *)
...
(** Observe that the type of [fold] is parameterized by _two_ type
    ...
    different? *)
(** X : bool, Y : nat. f : check if the natural number is even/odd. *)
...
Proof. 
  intros. induction l.
  - reflexivity.
  - unfold fold_map in IHl. unfold fold_map. simpl. rewrite -> IHl. reflexivity.
Qed.
(** [] *)
