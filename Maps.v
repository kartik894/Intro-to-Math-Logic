...
Theorem t_update_same : forall X x (m : total_map X),
  ...
  unfold t_update.
  extensionality i.
  destruct (beq_string x i) eqn:eqn1.
  - apply beq_string_true_iff in eqn1. rewrite eqn1. reflexivity.
  - reflexivity.
Qed.
(** [] *)
...
Proof.
  ...
  unfold t_update.
  extensionality i.
  destruct (beq_string x1 i) eqn:eqn1.
  - apply beq_string_true_iff in eqn1. rewrite <- eqn1. rewrite -> false_beq_string. reflexivity. apply H.
  - reflexivity.
Qed.
(** [] *)
