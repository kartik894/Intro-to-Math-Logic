...
Theorem test_bin_incr1: bin_to_nat (incr_bin BO) = S 0.
Proof. reflexivity. Qed.

Theorem test_bin_incr2: bin_to_nat (incr_bin (MA BO)) = S 1.
Proof. reflexivity. Qed.

Theorem test_bin_incr3: MA (D (incr_bin BO)) = MA (incr_bin (incr_bin BO)).
Proof. reflexivity. Qed.

Theorem test_bin_incr4:  bin_to_nat (MA ( MA (D (incr_bin BO)) )) = S 10.
Proof. reflexivity. Qed.

Theorem test_bin_incr5:  bin_to_nat (D ( MA (D (incr_bin BO)) )) = S 9.
Proof. reflexivity. Qed.
(** [] *)
